<template>
    <view class="content"> 
        ...
        <form-create-uni ref="formCreateRef"  :submitBtn="false" :rule="formDetailPreview.rule" :option="formDetailPreview.option" v-model="formDetailPreview.value" @submit="submit"></form-create-uni>
...
const setConfAndFields2 = (
  ...
  formCreateRef.value.showForm(detailPreview.rule)
  formCreateRef.value.setFormValues(valueJson)
  
  
  if (value) {
    // @ts-ignore
    detailPreview.value = value
	formCreateRef.value.setFormValues(value)
  }
}

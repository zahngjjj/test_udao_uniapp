<template>
  <uni-popup ref="copyPopup" type="bottom" :mask-click="false">
    <view class="copy-modal">
      <view class="modal-header">
        <text class="modal-title">抄送任务</text>
        <text class="close-btn" @click="handleCancel">×</text>
      </view>
      
      <view class="modal-content">
        <!-- 抄送人选择 -->
        <view class="copy-users-section">
          ...
          <button class="select-user-btn" @click="showUserSelector">
            {{ selectedUsers.length > 0 ? '重新选择抄送人' : '选择抄送人' }}
          </button>
        </view>
        
        <!-- 抄送意见 -->
        <view class="copy-reason-section">
          <text class="section-title">抄送意见</text>
          <textarea
            v-model="copyReason"
            placeholder="请输入抄送意见"
            ...
            maxlength="500"
          />
          <text class="char-count">{{ copyReason.length }}/500</text>
        </view>
      </view>
  ...
  <uni-popup ref="userSelectorPopup" type="bottom" :mask-click="false">
    <view class="user-selector-modal">
      <view class="modal-header">
        <text class="modal-title">选择抄送人</text>
